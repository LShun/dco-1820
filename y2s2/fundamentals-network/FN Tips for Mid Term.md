...
- [Notes](#notes)
  ...
  - [C2](#c2)
    ...
    - [Network Protocols (OPTIONAL) :heavy_plus_sign:](#network-protocols-optional-heavyplussign)
  ...
  - [C4](#c4)
    ...
    - [Physical vs Logical Topology](#physical-vs-logical-topology)
      - [Logical Topologies :grey_question: :heavy_plus_sign:](#logical-topologies-greyquestion-heavyplussign)
